1. Projekt_AI cel:
Projekt to „Klasyfikator parzystości oparty na sieci neuronowej”.
Program uczy się rozpoznawać regułę logiczną (co najmniej dwie liczby parzyste z trzech podanych).

3. Architektura sieci (Struktura)
